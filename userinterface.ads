...
package UserInterface is
   ...
   protected type User_Access is
      ...
      procedure Difficulty_Set (Difficulty : Integer; Check_Input : out Boolean);
      function Difficulty_Get return Level;
   private
      User : User_Type := (Name => To_Unbounded_String("Test"), Difficulty => 1);
   end User_Access;
   ...
   procedure Print_Equation_Integer(Left : Integer; Right : Integer; Operation : Operation_Type);
   procedure Print_Equation_Float(Left : Float; Right : Float; Operation : Operation_Type);
