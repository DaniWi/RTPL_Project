package body UserInterface is
   ...
   protected body User_Access is
      ...
      procedure Difficulty_Set (Difficulty : Integer; Check_Input : out Boolean) is
      begin
   ...
   begin
      ...
      Put_Line("You will be provided with 10 tasks to solve whereby your processing time is measured.");
      Put_Line("Press any key to start with the first task!");
      Get_Immediate(key);
      Put_Line(Get_Line);
   end Print_Explanation;

   procedure Print_Equation_Integer(Left : Integer; Right : Integer; Operation : Operation_Type) is
   begin
      Put(Left'Img);
      case Operation is
         when ADD => Put(" +");
   ...
   procedure Print_Equation_Float(Left : Float; Right : Float; Operation : Operation_Type) is
   begin
