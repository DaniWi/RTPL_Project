package body Game is
   ...
   procedure startGame is
      ...
      package Generator_Integer is new Ada.Numerics.Discrete_Random (Integer_Range);
      ...
      task type Task_Easy(Random_Operation : Operation_Type; Gen_Integer : ACCESS_TO_GEN_INT) is
         entry Start;
      end Task_Easy;
      task type Task_Hard(Random_Operation : Operation_Type; Gen_Float : ACCESS_TO_GEN_FLOAT) is
         entry Start;
      end Task_Hard;
      ...
      task body Task_Easy is
         LHS : Integer := Generator_Integer.Random(Gen_Integer.all);
         RHS : Integer := Generator_Integer.Random(Gen_Integer.all);
   ...
   begin
      ...
      for i in Integer range 1 .. 2 loop --loop to create 10 random assignments
         ...
         end case; --random choose of assignment type and creation of the needed task type
